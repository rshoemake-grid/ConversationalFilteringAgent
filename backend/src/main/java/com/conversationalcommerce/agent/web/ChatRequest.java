...
public record ChatRequest(
        ...
        @Schema(description = "productTotalSize from prior assistant (with previousProductFilter); keeps broader catalog count in UI when Retail returns a smaller narrowed total") Long previousProductTotalSize,
        @Schema(description = "Prior assistant productTotalSizeIsApproximate; echoed with previousProductTotalSize") Boolean previousProductTotalSizeIsApproximate,
